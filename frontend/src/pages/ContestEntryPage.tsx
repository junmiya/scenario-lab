  ...
  const loadData = async () => {
    ...
    try {
      const [c, e] = await Promise.all([
        ...
        getContestEntry(contestId, entryId),
      ]);
      setContest(c);
      setEntry(e);
      if (c && isEvaluator) {
