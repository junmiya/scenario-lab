...
export function GroupListPage(): ReactElement {
    ...
    const handleCreate = async () => {
        ...
        setCreating(true);
        try {
            const id = await createGroup(user.uid, newName.trim(), newDesc.trim(), user.displayName ?? undefined, user.email ?? undefined);
                    ...
                    <div style={{
                        ...
                        <div style={{ marginBottom: '0.75rem' }}>
                            ...
                            <input
                                ...
                                style={{
                                    ...
                                    borderRadius: 'var(--radius-md)', fontSize: '0.875rem', boxSizing: 'border-box',
                                }}
                            />
                        </div>
                        <div style={{ marginBottom: '1rem' }}>
                            ...
                            <textarea
                                ...
                                style={{
                                    width: '100%', padding: '0.5rem 0.75rem', border: '1px solid var(--border)',
                                    borderRadius: 'var(--radius-md)', fontSize: '0.875rem', resize: 'vertical', boxSizing: 'border-box',
                                }}
                            />
                        </div>
                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    fontSize: '0.8125rem', cursor: 'pointer', border: '1px solid var(--border)',
                                }}
                            >
                                キャンセル
                            </button>
                ...
                {!loading && groups.length === 0 && (
                    <div style={{
                        ...
                        <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
                            {canCreate ? '「新規作成」ボタンでグループを作成できます。' : '運営者からグループに招待してもらってください。'}
                        </p>
                        {errorMsg && <p style={{ color: '#dc2626', fontSize: '0.75rem', marginTop: '0.5rem' }}>{errorMsg}</p>}
                    </div>
                )}
