...
import { Trophy, Send, ChevronRight, Settings } from 'lucide-react';
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        >
          <div>
            ...
            >
              ステータス: {STATUS_LABELS[contest.status] || contest.status} ・ エントリー{' '}
              {entries.length}件
            </p>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {sortedEntries.map((e) => (
              <div
                ...
                onMouseEnter={(ev) => {
                  ev.currentTarget.style.borderColor = 'var(--text-secondary)';
                }}
                onMouseLeave={(ev) => {
          ...
          >
            ...
            >
              ...
              <select
                ...
                onChange={(ev) => setSelectedScriptId(ev.target.value)}
                style={{
                  width: '100%',
              ...
              <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'flex-end' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    border: 'none',
                    opacity: submitting || !selectedScriptId ? 0.5 : 1,
                  }}
                >
                  応募
                </button>
