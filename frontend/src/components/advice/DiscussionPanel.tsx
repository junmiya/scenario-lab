    ...
    const startDiscussion = useCallback(async () => {
        ...
        try {
            for (let round = 0; round < ROUNDS; round++) {
                ...
                const aMsg: DiscussionMessage = { role: 'A', provider: providerA, text: aText, timestamp: Date.now() };
                ...
                const bMsg: DiscussionMessage = { role: 'B', provider: providerB, text: bText, timestamp: Date.now() };
        ...
        <div>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                    <span style={{ fontSize: '0.75rem', fontWeight: 600, color: PROVIDER_COLORS.A }}>採点者A</span>
                    <select
                        value={providerA}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                    <span style={{ fontSize: '0.75rem', fontWeight: 600, color: PROVIDER_COLORS.B }}>採点者B</span>
                    <select
                        value={providerB}
                        ...
                        <div key={i} style={{
                            ...
                            <div style={{
                                ...
                                <span style={{
                                    ...
                                    backgroundColor: 'var(--color-surface)', padding: '0.0625rem 0.25rem',
