...
interface CorrectionEditorProps {
    ...
    lineCount?: number;
    onTextSelect?: ((selection: { startOffset: number; endOffset: number; text: string }) => void) | undefined;
    onCorrectionClick?: ((correctionId: string) => void) | undefined;
}

export function CorrectionEditor({
    text, field, corrections, activeCorrectionId,
    charsPerColumn = 20, lineCount = 20,
    onTextSelect, onCorrectionClick,
                                        ...
                                        : isAccepted
                                            ...
                                            : isRejected
                                                ...
                                                : highlightedId === seg.correction.id
                                                    ? 'rgba(220, 38, 38, 0.15)'
                                                    : 'rgba(220, 38, 38, 0.1)',
                                    borderBottom: isPending ? '2px solid #dc2626' : isAccepted ? '2px solid #16a34a' : '2px solid #9ca3af',
                                    cursor: 'pointer',
...
function buildSegments(text: string, corrections: Correction[], activeId: string | null): Segment[] {
